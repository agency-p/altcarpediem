import "file:///home/philipp/Desktop/carpediem/node_modules/unenv/runtime/polyfill/fetch.node.mjs";
...
import {
  provider,
  isWindows,
} from "file:///home/philipp/Desktop/carpediem/node_modules/std-env/dist/index.mjs";
import {
  toEventHandler,
  defineEventHandler,
  handleCacheHeaders,
  ...
  eventHandler,
  useQuery,
} from "file:///home/philipp/Desktop/carpediem/node_modules/h3/dist/index.mjs";
import {
  createFetch as createFetch$1,
  Headers,
} from "file:///home/philipp/Desktop/carpediem/node_modules/ohmyfetch/dist/node.mjs";
import destr from "file:///home/philipp/Desktop/carpediem/node_modules/destr/dist/index.mjs";
import { createRouter as createRouter$1 } from "file:///home/philipp/Desktop/carpediem/node_modules/radix3/dist/index.mjs";
import {
  createCall,
  createFetch,
} from "file:///home/philipp/Desktop/carpediem/node_modules/unenv/runtime/fetch/index.mjs";
import { createHooks } from "file:///home/philipp/Desktop/carpediem/node_modules/hookable/dist/index.mjs";
import { hash } from "file:///home/philipp/Desktop/carpediem/node_modules/ohash/dist/index.mjs";
import { createStorage } from "file:///home/philipp/Desktop/carpediem/node_modules/unstorage/dist/index.mjs";
import _unstorage_drivers_fs from "file:///home/philipp/Desktop/carpediem/node_modules/unstorage/dist/drivers/fs.mjs";
import {
  withQuery,
  joinURL,
} from "file:///home/philipp/Desktop/carpediem/node_modules/ufo/dist/index.mjs";
import { createRenderer } from "file:///home/philipp/Desktop/carpediem/node_modules/vue-bundle-renderer/dist/index.mjs";
import devalue from "file:///home/philipp/Desktop/carpediem/node_modules/@nuxt/devalue/dist/devalue.mjs";
import { snakeCase } from "file:///home/philipp/Desktop/carpediem/node_modules/scule/dist/index.mjs";
import htmlTemplate from "/home/philipp/Desktop/carpediem/.nuxt/views/document.template.mjs";
import { renderToString as renderToString$2 } from "file:///home/philipp/Desktop/carpediem/node_modules/vue/server-renderer/index.mjs";
...
const serverAssets = [
  { baseName: "server", dir: "/home/philipp/Desktop/carpediem/server/assets" },
];
...
storage.mount(
  "root",
  _unstorage_drivers_fs({
    driver: "fs",
    base: "/home/philipp/Desktop/carpediem",
  })
);
storage.mount(
  "src",
  _unstorage_drivers_fs({
    driver: "fs",
    base: "/home/philipp/Desktop/carpediem/server",
  })
);
storage.mount(
  "build",
  _unstorage_drivers_fs({
    driver: "fs",
    base: "/home/philipp/Desktop/carpediem/.nuxt",
  })
);
storage.mount(
  "cache",
  _unstorage_drivers_fs({
    driver: "fs",
    base: "/home/philipp/Desktop/carpediem/.nuxt/cache",
  })
);
...
function defineCachedFunction(fn, opts) {
  ...
  async function get(key, resolver) {
    const cacheKey = [opts.base, group, name, key]
      .filter(Boolean)
      .join(":")
      .replace(/:\/$/, ":index");
...
function isJsonRequest(event) {
  return (
    hasReqHeader(event.req, "accept", "application/json") ||
...
function normalizeError(error) {
  ...
  const statusMessage =
    error.statusMessage ??
    (statusCode === 404 ? "Route Not Found" : "Internal Server Error");
...
const handlers = [
  { route: "/__nuxt_error", handler: _e2b0d4, lazy: true, method: undefined },
  { route: "/**", handler: _e2b0d4, lazy: true, method: undefined },
];
...
const getClientManifest = cachedImport(() =>
  import(
    "/home/philipp/Desktop/carpediem/.nuxt/dist/server/client.manifest.mjs"
  )
);
const getSSRApp =
  !process.env.NUXT_NO_SSR &&
  cachedImport(() =>
    import("/home/philipp/Desktop/carpediem/.nuxt/dist/server/server.mjs")
  );
const getSSRRenderer = cachedResult(async () => {
  ...
  const { renderToString: renderToString2 } = await Promise.resolve().then(
    function () {
      return vue3;
    }
  );
    ...
    return {
      ...
      renderStyles: () =>
        entryFiles
          ...
          .filter((css) => css != null)
          .map(
            (file) => `<link rel="stylesheet" href="${buildAssetsURL(file)}">`
          )
          .join(""),
      renderScripts: () =>
        entryFiles
          .map(({ file }) => {
            ...
            return `<script ${
              isMJS ? 'type="module"' : ""
            } src="${buildAssetsURL(file)}"><\/script>`;
          })
          .join(""),
    };
  };
...
function renderToString$1(ssrContext) {
  const getRenderer =
    NUXT_NO_SSR || ssrContext.noSSR ? getSPARenderer : getSSRRenderer;
...
const renderer = eventHandler(async (event) => {
  ...
  if (url.startsWith(STATIC_ASSETS_BASE) && url.endsWith(PAYLOAD_JS)) {
    isPayloadReq = true;
    url =
      url.slice(STATIC_ASSETS_BASE.length, url.length - PAYLOAD_JS.length) ||
      "/";
  }
  const ssrContext = {
    url,
...
const renderToString = (...args) => {
  return renderToString$2(...args).then(
    (result) => `<div id="__nuxt">${result}</div>`
  );
};
